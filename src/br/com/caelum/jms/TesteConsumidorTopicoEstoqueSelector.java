...
public class TesteConsumidorTopicoEstoqueSelector {
	...
	public static void main(String[] args) throws Exception {
		...
		MessageConsumer consumer = session.createDurableSubscriber(topico, "assinatura-selector", "ebook is null OR ebook=false", false); // false=nao quero receber mensagens da mesma conexao que estou recebendo mensagens (propria conexao)
